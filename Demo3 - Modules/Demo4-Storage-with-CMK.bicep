...
var StorageAccountKvCryptoUserRole = subscriptionResourceId(
  'Microsoft.Authorization/roleDefinitions',
  'e147488a-f6f5-4113-8e2d-b22465e65bf6')
resource StorageAccountKvCryptoUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(StorageAccountKvCryptoUserRole, vault.id, storageIdentity.id)
  scope: vault
  properties: {
    principalId: storageIdentity.properties.principalId
    roleDefinitionId: StorageAccountKvCryptoUserRole
  }
}

var AdminKvCryptoOfficerRole = subscriptionResourceId(
  'Microsoft.Authorization/roleDefinitions',
  '14b46e9e-c2b7-41b4-b07b-48a6ebf60603')
resource AdminKvCryptoOfficer 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(AdminKvCryptoOfficerRole, vault.id, adminPrincipalId)
  scope: vault
  properties: {
    principalId: adminPrincipalId
    roleDefinitionId: AdminKvCryptoOfficerRole
  }
}
